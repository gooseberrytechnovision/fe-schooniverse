...
const FAQs = () => {
  ...
  const FAQS = [
    ...
    },
    {
      ...
      answer: "The uniform order must be placed by 30th May 2025 to ensure timely delivery and your child attends school in proper uniform as per the school dress code policy."
    },
    {
